...
insert into CLIENT(id, firstname, lastname, email, locationid) values(1, 'Kindson', 'Munonye', 'kany@gmail.com', 1);
insert into CLIENT(id, firstname, lastname, email, locationid) values(2, 'Jeffrey', 'Yuba', 'yuba@gmail.com', 2);
insert into CLIENT(id, firstname, lastname, email, locationid) values(3, 'Solace', 'Okeke', 'solace@gmail.com', 3);
